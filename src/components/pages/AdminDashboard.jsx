...
const AdminDashboard = () => {
    // A single, consistent theme color for all cards
    const themeColor = "#0d6efd"; // Bootstrap Primary Blue
    ...
    const adminTasks = [
        {
            ...
            icon: <FaChalkboardTeacher size={28} style={{ color: themeColor }} />
        },
        {
            ...
            icon: <FaBookOpen size={28} style={{ color: themeColor }} />
        },
        {
